...
int main(){
	...
	vector<vector<vector<vector<double>>>> localDensityall = calclocalDensityLammpstrajdata("PEmeltPolyHDPE17_58_smallerinboxcen.data", "meltcrystalizing_17_58_Poly_smaller.lammpstrj", resolutions, 64874, 487530, coordinateindices,outfiledens,4);
	...
	InfoLmpsTraj info = calcP2CrystandlocalLammpstrajdata("PEmeltPolyHDPE17_58_smallerinboxcen.data","meltcrystalizing_17_58_Poly_smaller.lammpstrj", resolutions, 64874, 487530, coordinateindices,outfileorder,4);
